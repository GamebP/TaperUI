...
local function performThrow()
    -- First remote: InvokeServer (waits for a response)
    local beginEvent = game:GetService("ReplicatedStorage").Network["Throw/Begin"]
    beginEvent:InvokeServer()

    -- Wait 0.5 seconds (blocking the current thread)
    task.wait(0.5)  -- equivalent to wait(0.5)

    -- Second remote: FireServer with the given value
    local updateEvent = game:GetService("ReplicatedStorage").Network["Throw/Update"]
    updateEvent:FireServer(3439345.1)
    ...
    local Event = game:GetService("ReplicatedStorage").Network["Throw/End"]
    Event:FireServer()
end
...
task.spawn(function()
    local Event = game:GetService("ReplicatedStorage").Network["Training/Throw"]
    local count = 100  -- change to however many times you need

    for i = 1, count do
        Event:FireServer("Wall1", false) -- WAll1, Wall2, Wall3 .. to Wall12
        task.wait(0.1)  -- wait 0.1 seconds between each fire
    end
end)
...
local Event = game:GetService("ReplicatedStorage").Network["Egg/Open"]
Event:InvokeServer(
    "Egg2", -- Egg1, Egg2, Egg3
    3 -- How much?
)
...
local Event = game:GetService("ReplicatedStorage").Network["Pets/EquipBest"]
Event:FireServer()
...
local Event = game:GetService("ReplicatedStorage").Network["Rebirth/Upgrade"]
Event:InvokeServer()
...
return function(parent, config)
    ...
    elements:Slider("Throw Delay (s)", parent, 0.5, 5.0, throwInterval, 1, function(val)
        throwInterval = val
    end)
    ...
    elements:Slider("Training Rate (s)", parent, 0.05, 2.0, strengthInterval, 2, function(val)
